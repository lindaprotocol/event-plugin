 ...
 */
package org.linda.eventplugin.app;
...
import org.linda.common.logsfilter.IPluginEventListener;
import org.linda.common.logsfilter.trigger.BlockLogTrigger;
import org.linda.common.logsfilter.trigger.Trigger;
...
public class PluginLauncher {
    ...
    public static void main(String[] args) {
        String path = "/Users/linda/sourcecode/eventplugin/build/plugins/plugin-mongodb-1.0.0.zip";
        ...
        eventListeners.forEach(listener -> {
            listener.setDBConfig("eventlog|linda|123456");
        });
